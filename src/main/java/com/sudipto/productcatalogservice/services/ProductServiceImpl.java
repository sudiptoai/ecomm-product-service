...
public class ProductServiceImpl implements IProductService {
    ...
    public List<Products> getAllProductsByCategory(String category) {
        ResponseEntity<FakeStoreProductDTO[]> fakeStoreProductsByCategory = restTemplate.getForEntity("https://fakestoreapi.com/products/" + category, FakeStoreProductDTO[].class, category);
        List<Products> products = new ArrayList<>();
